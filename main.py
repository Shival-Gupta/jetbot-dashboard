...
load_dotenv()
print(f"Attempting to load .env file. Found SECRET_KEY: {'Yes' if os.getenv('SECRET_KEY') else 'No'}")
...
# Give serial-monitor its socketio instance
...
# Existing serial event handlers
@socketio.on('connect')
def sio_connect():
